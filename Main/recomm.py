...
def recom(books_user_likes):
	...
	books = pd.read_csv(r"E:\DATA\Project\machine learning\Book-Recommendation-System\BookDataset\Bookz.csv")
	books=books[:1000]
	df=books
	img=pd.read_csv(r"E:\DATA\Project\machine learning\Book-Recommendation-System\BookDataset\Imagez.csv")
...
def bookdisp():
	books=pd.read_csv("E:\DATA\Project\machine learning\Book-Recommendation-System\BookDataset\Bookz.csv")
	img=pd.read_csv("E:\DATA\Project\machine learning\Book-Recommendation-System\BookDataset\Imagez.csv")
